class SurveyForm1Texts {
  static const formTexttitle = 'ڈیجیٹل سیفٹی رپورٹ فارم';
  static const formTextTitleDescription =
      ' یہ فارم تمام ملازمین کے لیے تیار کیا گیا ہے تاکہ وہ کام کے دوران کسی بھی خطرے، غیر محفوظ عمل، یا قریب الوقوع حادثے (Near Miss) کی فوری رپورٹ کرسکیں۔';
  static const formObjection = '⚠️ براہ کرم کسی بھی غیر محفوظ حالت یا واقعے کے فوراً بعد یہ فارم پُر کریں۔ ';
  static const reportername = 'رپورٹ کرنے والے کا نام';
  static const date = 'مشاہدے کی تاریخ';
